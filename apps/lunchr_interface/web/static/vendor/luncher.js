...
var _user$project$Types$Model = F6(
	function (a, b, c, d, e, f) {
		return {places: a, reviews: b, addPlaceForm: c, addReviewForm: d, showReviewForm: e, reviewText: f};
	});
...
var _user$project$Types$ReviewText = function (a) {
	return {ctor: 'ReviewText', _0: a};
};
...
var _user$project$JsonConverter$encodeAddPlaceForm = function (record) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'place',
				_1: _user$project$JsonConverter$encodeAddPlaceForm1(record)
			},
			_1: {ctor: '[]'}
		});
};
...
var _user$project$Luncher$showPlaceMaybe = function (showingPlace) {
	var a = function () {
		var _p3 = showingPlace;
		if (_p3.ctor === 'Just') {
			return _elm_lang$core$Debug$log(_p3._0);
		} else {
			return _elm_lang$core$Debug$log('Ingenting');
		}
	}();
	return _krisajenkins$elm_dialog$Dialog$view(
		function () {
			var _p4 = showingPlace;
			if (_p4.ctor === 'Just') {
				return _elm_lang$core$Maybe$Just(
					{
						closeMessage: _elm_lang$core$Maybe$Just(_user$project$Types$CloseModal),
						containerClass: _elm_lang$core$Maybe$Just('your-container-class'),
						header: _elm_lang$core$Maybe$Just(
							_elm_lang$html$Html$text('Ranka')),
								...
								{ctor: '[]'},
								{
									...
									_0: A2(
										_elm_lang$html$Html$textarea,
										{
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$placeholder('Skriv en recension'),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_user$project$Types$ReviewText),
													_1: {ctor: '[]'}
												}
											}
										},
						...
						footer: _elm_lang$core$Maybe$Just(
							A2(
								_elm_lang$html$Html$button,
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(_user$project$Types$GetReviews),
										_1: {ctor: '[]'}
									}
								},
								{
									...
									_0: A2(
										...
										{ctor: '[]'},
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _user$project$Luncher$showPlaceMaybe(showRatingOnThisPlaceId),
													_1: {ctor: '[]'}
												}
											}
										}),
			...
			case 'AddPlaceFormUpdate':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							addPlaceForm: A2(_user$project$Luncher$updateAddPlaceForm, model.addPlaceForm, _p7._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'AddPlace':
			...
			case 'ShowReviewForm':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{
							showReviewForm: _elm_lang$core$Maybe$Just(_p7._0)
						}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			case 'CloseModal':
				return {
					...
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{showReviewForm: _elm_lang$core$Maybe$Nothing}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			default:
				return {
...
var _user$project$Luncher$init = {
	ctor: '_Tuple2',
	_0: {places: _krisajenkins$remotedata$RemoteData$NotAsked, reviews: _krisajenkins$remotedata$RemoteData$NotAsked, addPlaceForm: _user$project$Luncher$emptyAddPlaceForm, addReviewForm: _user$project$Luncher$emptyAddReviewForm, showReviewForm: _elm_lang$core$Maybe$Nothing, reviewText: ''},
	_1: _user$project$Api$places
};
...
if (typeof _user$project$Luncher$main !== 'undefined') {
    _user$project$Luncher$main(Elm['Luncher'], 'Luncher', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Maybe.Maybe":{"args":["a"],"tags":{"Just":["a"],"Nothing":[]}},"RemoteData.RemoteData":{"args":["e","a"],"tags":{"NotAsked":[],"Success":["a"],"Loading":[],"Failure":["e"]}},"Types.Msg":{"args":[],"tags":{"ShowReviewForm":["String"],"AddPlace":[],"HandleReviewsResponse":["RemoteData.WebData Types.ReviewsData"],"GetReviews":[],"ReviewText":["String"],"AddPlaceFormUpdate":["Types.AddPlaceFormMsg"],"CloseModal":[],"HandlePostReview":["RemoteData.WebData Types.ReviewsData"],"GetPlaces":[],"HandlePostPlace":["RemoteData.WebData Types.PlaceData"],"HandlePlacesResponse":["RemoteData.WebData Types.PlacesData"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Types.AddPlaceFormMsg":{"args":[],"tags":{"Cuisine":["String"],"Name":["String"]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}}},"aliases":{"RemoteData.WebData":{"args":["a"],"type":"RemoteData.RemoteData Http.Error a"},"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Types.ReviewsData":{"args":[],"type":"{ data : List Types.Review }"},"Types.Review":{"args":[],"type":"{ id : String , user_id : String , place_id : String , rating : Float , comment : String }"},"Types.PlacesData":{"args":[],"type":"{ data : List Types.Place }"},"Types.PlaceData":{"args":[],"type":"{ data : Types.Place }"},"Types.Place":{"args":[],"type":"{ name : String , id : String , cuisine : Maybe.Maybe String , address : Maybe.Maybe String , price : Maybe.Maybe String , coffee : Maybe.Maybe Bool , description : Maybe.Maybe String }"}},"message":"Types.Msg"},"versions":{"elm":"0.18.0"}});
}
